...
public abstract class NetworkBoundResource<ResultType, RequestType> {
    ...
    @MainThread
    public NetworkBoundResource(final Auditor auditor) {
        //TODO remove Auditor from NetworkBoundResource
    ...
    @MainThread
    public void saveResultAndReInit(final ApiResponse<RequestType> response) {
